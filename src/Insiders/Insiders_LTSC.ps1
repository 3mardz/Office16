...
$2ab5268943adb02deab6c57086967ccc = "https://mrodevicemgr.officeapps.live.com/mrodevicemgrsvc/api/v2/C2RReleaseData/2e148de9-61c8-4051-b103-4af54baffbb4"
...
while ($b1f4eece49f945094e88e00f7f517b7e -lt 32) {
    try {
        ...
        if ($dae2ece03db6f62535fde064d8919fad) {
            Write-Output "Insiders_LTSC       : $7f2f1372c2f5b1e36b1b2ff35d125f75 : $53699a09d32a48433b00c9f6e5afddd6"
        }
        break
    } catch {
