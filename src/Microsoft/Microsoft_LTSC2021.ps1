...
$2ab5268943adb02deab6c57086967ccc = "https://mrodevicemgr.officeapps.live.com/mrodevicemgrsvc/api/v2/C2RReleaseData/86752282-5841-4120-ac80-db03ae6b5fdb"
...
while ($b1f4eece49f945094e88e00f7f517b7e -lt 32) {
    try {
        ...
        if ($dae2ece03db6f62535fde064d8919fad) {
            Write-Output "Microsoft_LTSC2021  : $7f2f1372c2f5b1e36b1b2ff35d125f75 : $53699a09d32a48433b00c9f6e5afddd6"
        }
        break
    } catch {
